...
#credits to teamopenfire and Ajith KP
#added subdomain admin panels
...
def ipoy():
    ...
    try:
        ...
        print "\t# ██║  ██╗   ██║   ██║  ██║ ██║╚██████╔╝███████║██╗██║     ██║  ██║ #"
        print "\t# ╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝ ╚═╝ ╚═════╝ ╚══════╝╚═╝╚═╝     ╚═╝  ╚═╝ #"
        print "\t#                                                   AdminPageFinder #"
        print "\t#                        credits to www.teamopenfire.com & Ajith KP #"
        print "\t#####################################################################"
        ...
        Subdomain = ['admin','administrator','admin1','admin2','admin3','admin4','admin5','usuarios','usuario','administrator','moderator','webadmin','adminarea','bb-admin','adminLogin','admin_area','panel-administracion','instadmin','memberadmin','administratorlogin','adm']
